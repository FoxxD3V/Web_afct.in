              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      <img src="../upload/tl_data/image/<?php echo $edit_data['image'];?>" alt="Admin" class="rounded-circle" width="150">
                      <div class="mt-3">
                        <h4> <?php echo $edit_data['t_name']?></h4>
                        <p class="text-secondary mb-1">Faculty / Teacher</p>
                        <p class="text-muted font-size-sm">Reg Id : <?php echo  ($edit_data['user'])?>  </p>
                        <p class="text-muted font-size-sm">DOJ : <?php echo date_dmy_small($edit_data['autodate'])?>  </p>
                        <p class="text-muted font-size-sm"> <?php echo  ($edit_data['c_code'])?> / <?php echo  ($edit_data['c_name'])?>  </p>
                        <p class="text-muted font-size-sm">Exp : <?php echo  ($edit_data['edu_year'])?> Year <?php echo  ($edit_data['edu_mon'])?>  </p>
                ...
                <div class="card mt-3">
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 class="mb-0"> Franchise Director ID</h6>
                      <span class="text-secondary"><?php     echo $edit_data['a_fdl_id'];?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 class="mb-0"> Franchise Director Name</h6>

                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">

                      <span class="text-secondary"><?php     echo $edit_data['a_fdl_name'];?></span>
                    </li>
              ...
              <div class="col-md-8">
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <h6 class="mb-0">Educational Info</h6>
                      </div>
                      <div class="col-sm-9 text-secondary">
                        Course : <?php echo $edit_data['c_name'];?>
                        <small>[<?php echo $edit_data['c_code'];?>]</small><br>
                        Subject : <?php echo $edit_data['c_subj'];?><br>
                        Edu : <?php echo $edit_data['education'];?><br>
                        EXP : <?php echo $edit_data['edu_mon'];?> Month <?php echo $edit_data['edu_year'];?> Year
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <img src="../upload/tl_data/uid/<?php echo $edit_data['uid_img'];?>" alt="Admin" class="img-fluid" >

                      </div>
                      <div class="col-sm-6  ">
                        <img src="../upload/tl_data/uid/<?php echo $edit_data['uid_img_back'];?>" alt="Admin" class="img-fluid"  >
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <img src="../upload/tl_data/pan/<?php echo $edit_data['pan_img'];?>" alt="Admin" class="img-fluid"  >
