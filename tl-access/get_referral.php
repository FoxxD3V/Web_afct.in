...
include("../con_base/functions.inc.php");
   ...
   if($typ!='')
   {
    ...
    $qry="select *  from tbl_team_fact where user like '%" . $_POST['id'] . "%'   ";
      $typ_full="Faculty / Teacher  ";
    }
    else if($typ=='sl'){
...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text"> <?php if( $typ!='tl') { if($typ!='sdl' ) { echo $datas_name['a_city_name']; ?> - <?php } echo $datas_name['a_state_name']; }  ?></p>
  </div>
