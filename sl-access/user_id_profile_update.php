...
if(isset($_POST['upd_data']))
{
  ...
  {
    uploadmaster("../upload/sl_data/uid/", 'uploaded_file2');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select 	uid_img from tbl_team_student where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/sl_data/uid/'.$row['uid_img']);
  ...
  {
    uploadmaster("../upload/sl_data/uid/", 'uploaded_file3');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select 	uid_img_back from  tbl_team_student where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/sl_data/uid/'.$row['uid_img_back']);
  ...
  {
    uploadmaster("../upload/sl_data/pan/", 'uploaded_file4');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select pan_img from tbl_team_student where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/sl_data/pan/'.$row['pan_img']);
           ...
           <form class="form-horizontal" role="form" method="post" action="" target="_parent" enctype="multipart/form-data">
                                            ...
                                            <div class="card-body text-primary">
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 ">  <input name="uid"      type="text"  placeholder="Enter Aadhar No." class="form-control" id="uid"  value="<?php echo $data_res['id_aadhar']?>"   required/>
                                                </div>
                                              </div>
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 col-form-label">
                                                  ...
                                                  <input name="pan" placeholder="Pan Card"  type="text"  class="form-control" id="pan" value="<?php echo $data_res['id_pan']?>"  pattern=".{10}" maxlength="10"/>
