...
<div class="horizontal-menu mb-4 shadow static-top bg-gradient-warning">
      ...
      <ul class="nav page-navigation">
        ...
        <li class="nav-item">
          ...
          <div class="submenu">
            <ul class="submenu-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="user_edu_update.php">  Edit Educational Qualification</a>
              </li>
              <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            ...
            <span class="menu-title">My Ref Students</span>
            <i class="fas fa-angle-down"></i>
          </a>
          <div class="submenu">
            <ul class="submenu-item">
