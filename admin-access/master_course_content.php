...
if (isset($_REQUEST['ban'])) {
  mysqli_query($DB_LINK, "update tbl_master_course_content set status='0' where id=" . $_GET['ban']) or die(mysqli_error());
  $_SESSION['msg'] = array('success', 'Banned Successfully');
  header("location:master_course_content.php");
  exit;
}
if (isset($_REQUEST['unban'])) {
  mysqli_query($DB_LINK, "update tbl_master_course_content set status='1' where id='" . $_GET['unban'] . "'   ") or die(mysqli_error());
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTableFullPage" width="100%" cellspacing="0">
                ...
                <?php
                $jcount = 0;
                $qry_user = mysqli_query($DB_LINK, "SELECT * FROM tbl_master_course_content order by id desc ");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="master_course_content_add.php?edit=<?php echo $data_user['id']; ?>"><i style="color:blue "
                        ...
                        &nbsp;<a href="master_course_content.php?ban=<?php echo $data_user['id']; ?> "><i
                           class="fa fa-check fa-lg" style="color:green" title="Ban"></i> </a>
                      <?php } else { ?>
                        &nbsp;<a href="master_course_content.php?unban=<?php echo $data_user['id']; ?> "><i
