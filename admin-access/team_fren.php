...
<head>
  ...
  <title>Franchise Directors | <?php echo $SITE_NAME;?></title>
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-1">
          <h1 class="h3 mb-2 text-gray-800">Franchise Directors</h1>

          <a href="team_fren_add.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Add New</a>
        </div>
        <!-- Page Heading -->

        <p class="mb-4">Franchise Directors list with basic info </p>


        <!-- DataTales Example -->
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Franchise Directors</h6>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTableFullPage" width="100%" cellspacing="0">
                ...
                <?php
                $jcount=0;
                $qry_user= mysqli_query($DB_LINK,"SELECT * FROM tbl_team_fren order by id desc ");
                foreach($qry_user as $data_user )
                {
                  ...
                  <tr>
                    ...
                    <td><?php echo $data_user['t_name'];?><br>
                      ...
                      <br>
                      ID : <?php echo $data_user['a_ddl_id'];?><br><?php echo $data_user['a_ddl_name'];?>
                    </td>
                    ...
                    <td>
                      ...
                      <?php } else  { ?>
                        &nbsp;<a href="team_fren.php?unban=<?php echo $data_user['id'];?> "  ><i class="fa fa-ban fa-lg" style="color:red" title="Unban"></i>  </a>
                      <?php }  ?>  <a href="javascript:void(0)"  onClick="return del(<?php echo $data_user['id'];?>,'team_fren.php')"> <i class=" fa-lg fa fa-trash  "  style="color:red" title="Delete"></i>   </a>
