                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group mt-3">
                                              <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="<?php   if(isset($_GET['edit'])) echo $edit_data['ins_id'];?>" name="ins_id" id="ins_id" required   class="form-control text-uppercase"   aria-label="Institute Code"  placeholder="Institute Code" aria-describedby="basic-addon2">
                                        ...
                                        <div class="col-sm-6">
                                          ...
                                          <div class="form-group btn-group">
                                            ...
                                            <div class="form-group">
                                              <div class="input-group mb-3">
                                                <!--onblur="onchangeajax_for_ddl(this.value);"-->
                                                <input type="text" value="<?php   if(isset($_GET['edit'])) echo $edit_data['referral_code'];?>" name="ref_code" id="ref_code" required placeholder="Enter Referral ID *" class="form-control text-uppercase" placeholder="Destrict Director ID" aria-label="Destrict Director ID" aria-describedby="basic-addon2">
                                                <div class="input-group-append">
