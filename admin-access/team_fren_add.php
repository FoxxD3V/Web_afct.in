...
if(isset($_POST['save']))
{
  ...
  /*  $study_center=strtoupper(trim($_POST['study_center']));
    ...
    ///
     if ($_POST['a_ddl_id'] != '') {
       $sqlst = mysqli_query($DB_LINK, "select *  from tbl_team_city where user='" . $_POST['a_ddl_id'] . "'") or die(mysqli_error());
       if (mysqli_num_rows($sqlst) > 0) {
         ...
         if (mysqli_query($DB_LINK, $sql_reg)) {
           ...
           header("Location: team_fren_add.php");
           exit;
         } else {
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              <div class="input-group mb-3">
                                                ...
                                                <input type="text" value="<?php   if(isset($_GET['edit'])) echo $edit_data['a_ddl_id'];?>" name="a_ddl_id" id="a_ddl_id" required placeholder="Destrict Director ID *" class="form-control text-uppercase" placeholder="Destrict Director ID" aria-label="Destrict Director ID" aria-describedby="basic-addon2">
                                                <div class="input-group-append">
                                                  <button class="btn btn-outline-primary btn-primary text-white " type="button" onclick="onchangeajax_for_ddl(a_ddl_id.value);">Find</button>
                                                </div>
                                              </div>
