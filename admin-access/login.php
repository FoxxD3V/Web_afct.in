              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
																			<img src="../assets/links/img/logo/logo_big.png" class="img-fluid"/>
                    <h1 class="h4 text-gray-900 mb-4"> </h1>
                  </div>
                  <form class="user" action="log.php" method="post">
                    <div class="form-group">
                      <input name="loginid" type="text" maxlength="8" class="form-control form-control-user"     placeholder="Enter Member Id">
                    </div>
                    <div class="form-group">
