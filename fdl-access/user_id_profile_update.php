...
if(isset($_POST['upd_data']))
{
  ...
  {
    uploadmaster("../upload/fdl_data/uid/", 'uploaded_file2');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select 	uid_img from tbl_team_fren where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/fdl_data/uid/'.$row['uid_img']);
  ...
  {
    uploadmaster("../upload/fdl_data/uid/", 'uploaded_file3');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select 	uid_img_back from  tbl_team_fren where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/fdl_data/uid/'.$row['uid_img_back']);
  ...
  {
    uploadmaster("../upload/fdl_data/pan/", 'uploaded_file4');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select pan_img from tbl_team_fren where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/fdl_data/pan/'.$row['pan_img']);
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          <img src="../upload/fdl_data/uid/<?php echo $data_res['uid_img'];?>" class="img-responsive img-fluid">
                                                    ...
                                                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            <img src="../upload/fdl_data/uid/<?php echo $data_res['uid_img_back'];?>" class="img-responsive img-fluid">
                                                    ...
                                                    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            <img src="../upload/fdl_data/pan/<?php echo $data_res['pan_img'];?>" class="img-responsive img-fluid">
