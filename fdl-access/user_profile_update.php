            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"> <strong> Assigned city Director  </strong></h6>
                  ...
                  <div class="row clearfix">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <label>City Director</label>
                        <select class="form-control  text-uppercase" name="a_sdl_id" id="a_sdl_id"      onChange="onchangeajax_for_sdl(this.value);">
                         <!-- <option value="">--Select State Director--</option>-->
                          <?php
                            $qry="select * from tbl_team_city where status='1' and   user='".$edit_data['a_ddl_id']."' order by user asc";
                      ...
                      <div class="form-group  ">
                        <div id="city_upd_by_sdl">
                          <label>Assigned City Related To City Director</label>
