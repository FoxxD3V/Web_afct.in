...
if(isset($_POST['save']))
{
   ...
   // $study_center_code=$_SESSION['study_center_code'];
    ...
    ///
     if ($_POST['a_fdl_id'] != '') {
       $sqlst = mysqli_query($DB_LINK, "select *  from tbl_team_fren where user='" . $_POST['a_fdl_id'] . "' and status='1'") or die(mysqli_error());
       if (mysqli_num_rows($sqlst) > 0)
       {
         ...
         //////Get  City Director Info ///
         $a_ddl_id = $datas_name['a_ddl_id'];
         $a_ddl_name = $datas_name['a_ddl_name'];

         //// Frenchise Director
         $a_fdl_name= $datas_name['t_name'];


         $state_code = substr($a_fdl_id, 0, 2);
         /////Get New id/////
         $new_id = $state_code . '' . $datas_name['a_city_id'] . 'T' . rand(100000, 999999);
         ...
         /// ins code
             ...
             $sql_reg = "insert into tbl_team_fact set 
            `user`='$new_id',
            `pass`='$pass', 
         ...
         if (mysqli_query($DB_LINK, $sql_reg)) {
           ...
           mail_sender($email, "yes", $text, $t_name, "Faculty / Teacher Registration : AFCT ");
           $_SESSION['msg'] = array('success', 'Registration Successfully completed your login ID- ' . $new_id . ' Password- ' . dec($pass));
           header("Location: team_fact.php");
           exit;
         } else {
           $_SESSION['msg'] = array('error', 'Something went wrong !!!');
         }
       } else {
         $_SESSION['msg'] = array('error', 'Franchise Director id not found !!!');
       }
     }
...
<head>
    ...
    <title>New Faculty / Teacher Registration	| <?php echo $SITE_NAME;?></title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">New Faculty / Teacher Registration</h1>
              <!--  <p class="mb-4">New Faculty / Teacher Registration	Form</p>-->
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group"onmouseover="onchangeajax_for_ddl(a_fdl_id.value);">
                                              <div class="input-group mb-3">
                                                ...
                                                <input type="text"  value="<?php   if(isset($_GET['edit'])) echo $edit_data['a_fdl_id']; else echo $_SESSION[ 'a_userid' ];?>"
                                                       onmouseover="onchangeajax_for_ddl(a_fdl_id.value);" onmouseenter="onchangeajax_for_ddl(a_fdl_id.value);"
                                                       name="a_fdl_id" id="a_fdl_id" required placeholder="Frenchise Director ID *" class="form-control text-uppercase disabled" readonly placeholder="Frenchise Director ID" aria-label="Frenchise Director ID" aria-describedby="basic-addon2">
                      ...
                      <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                          <div class="row clearfix">
                            <div class="col-sm-12">
                              <div class="form-group">
                                <input type="text" value="<?php   if(isset($_GET['edit'])) echo $edit_data['t_name'];?>" class="form-control text-uppercase" placeholder="Faculty Name *" name="t_name" required >
                              </div>
                                ...
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" value="<?php   if(isset($_GET['edit'])) echo $edit_data['c_subj'];?>" class="form-control text-uppercase" placeholder="Enter Course Subject *" name="c_subj" required >
                                  ...
                                  <div class="col-sm-6"><label>Education Qualification</label>
                                    <div class="form-group"  >
                                      <input type="text" value="<?php   if(isset($_GET['edit'])) echo $edit_data['education'];?>" class="form-control text-uppercase" placeholder="Enter Education Qualification *" name="education" required >
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control mr-2 text-uppercase" name="edu_year" id="edu_year"    >
                                        ...
                                        {
                                          ?>
                                          <option value="<?php echo  $i;?>" <?php   if(isset($_GET['edit'])) if($edit_data['edu_year']==$i)   { echo 'selected';   } ?>><?php echo  $i;?></option>
                                        <?php } ?>
                                      </select>
                                  ...
                                  <div class="col-sm-6"><label>Month</label>
                                    <div class="form-group"  >
                                      <select class="form-control mr-2 text-uppercase" name="edu_mon" id="edu_mon"    >
                                        ...
                                        {
                                          ?>
                                          <option value="<?php echo  $i;?>" <?php   if(isset($_GET['edit'])) if($edit_data['edu_mon']==$i)   { echo 'selected';   } ?>><?php echo  $i;?></option>
                                        <?php } ?>
                                      </select>
