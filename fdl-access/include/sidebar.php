...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
  ...
  <li class="nav-item  mobileshow    ">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#institute" aria-expanded="true" aria-controls="team_members">
    ...
    <div id="institute" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="master_institute_add.php"><i class="fas fa-angle-double-right"></i> Add Institute </a>

    <a class="collapse-item" href="master_institute.php"><i class="fas fa-angle-double-right"></i> View Institute</a>
