...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item <?php if($currentPG=="user_profile.php") echo 'active';?> ">
    <a class="nav-link" href="user_profile.php">
      <i class="fas fa-fw fa-user"></i>
      <span>Profile</span></a>
  </li>

  <li class="nav-item <?php if($currentPG=="master_course.php") echo 'active';?> ">
    <a class="nav-link" href="master_course.php">
  ...
  <li class="nav-item <?php if($currentPG=="master_course.php") echo 'active';?> ">
    <a class="nav-link" href="team_fren.php">

      <i class="fas fa-fw fa-user-secret"></i>
      <span>Franchise Directors</span></a>
  </li>
  ...
  <li class="nav-item <?php  if($currentPG=="student_add.php" || $currentPG=="student_list_unverified.php" || $currentPG=="student_list_verified.php"   ) echo 'active  ';  ?> ">
