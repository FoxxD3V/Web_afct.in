...
{
	$sql = "select * from tbl_team_city where user='".$_SESSION[ 'a_userid' ]."'  ";
	$result=mysqli_query($DB_LINK,$sql);
	$line=mysqli_fetch_array($result);
	if($line['pass']==enc(trim($_POST['opass'])))
	{
		if(mysqli_query($DB_LINK," update tbl_team_city set pass='".enc(trim($_POST['cpass']))."' where user='".$_SESSION[ 'a_userid' ]."'   and pass='".enc(trim($_POST['opass']))."'"))
		{
