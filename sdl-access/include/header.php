      ...
      <ul class="nav page-navigation">
        ...
        <li class="nav-item">
          ...
          <div class="submenu">
            <ul class="submenu-item">
                <li class="nav-item">
                 <a class="nav-link" href="team_city_add.php">Add District Directors</a>
               </li><li class="nav-item">
                 <a class="nav-link" href="team_city.php">View District Directors</a>
               </li>
              <li class="nav-item">
                <a class="nav-link" href="team_fren_add.php">Add Frenchise Directors</a>
              </li><li class="nav-item">
                <a class="nav-link" href="team_fren.php">View Frenchise Directors</a>
              </li>
              <li class="nav-item">
