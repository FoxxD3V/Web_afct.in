...
/*if(isset($_GET['del']))
{
    mysqli_query($DB_LINK,"delete from tbl_team_fren where id=".$_GET['del']) or die(mysqli_error());
...
{
    mysqli_query($DB_LINK,"update tbl_team_fren set status=0 where id=".$_GET['ban']) or die(mysqli_error());
...
{
    mysqli_query($DB_LINK,"update tbl_team_fren set status=1 where id='".$_GET['unban']."'   ") or die(mysqli_error());
    $_SESSION['msg']=array('success', 'Unbanned Successfully');
    header("location:team_city.php");
    exit;
}*/

$sql_data = " select * from  tbl_team_state where user='".$_SESSION[ 'a_userid' ]."'  ";
...
if(isset($_POST['upd_data']))
{
  ...
  {
    uploadmaster("../upload/sdl_data/uid/", 'uploaded_file2');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select 	uid_img from tbl_team_state where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/sdl_data/uid/'.$row['uid_img']);
  ...
  {
    uploadmaster("../upload/sdl_data/uid/", 'uploaded_file3');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select 	uid_img_back from  tbl_team_state where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/sdl_data/uid/'.$row['uid_img_back']);
  ...
  {
    uploadmaster("../upload/sdl_data/pan/", 'uploaded_file4');
    if ($finame != '')
    {
      $qry=mysqli_query($DB_LINK,"select pan_img from tbl_team_state where user='".$_SESSION[ 'a_userid' ]."' ") ;
      $row=mysqli_fetch_array($qry);
      unlink('../upload/sdl_data/pan/'.$row['pan_img']);
  ...
  $qry2="update  tbl_team_state set   
$i2 $i3 $i4 
uid='".$_POST['uid']."' , 
	pan='".$_POST['pan']."', 
        bank_edit_flag='0'           
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                      <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                          <img src="../upload/sdl_data/uid/<?php echo $data_res['uid_img'];?>" class="img-responsive img-fluid">
                                                    ...
                                                    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            <img src="../upload/sdl_data/uid/<?php echo $data_res['uid_img_back'];?>" class="img-responsive img-fluid">
                                                    ...
                                                    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                      <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            <img src="../upload/sdl_data/pan/<?php echo $data_res['pan_img'];?>" class="img-responsive img-fluid">
