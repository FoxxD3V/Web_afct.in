          ...
          <div class="card-body">
            <div class="table-responsive">
             ...
             <!--     <th>STUDY CENTER</th>-->
                ...
                <?php
                $jcount=0;
                $qry_user= mysqli_query($DB_LINK,"SELECT * FROM tbl_team_fren  where a_sdl_id='".$_SESSION[ 'a_userid' ]."' order by id desc ");
                foreach($qry_user as $data_user )
                {
                  ...
                  <tr>
                   ...
                   <!-- <td><?php /*echo $data_user['study_center_code'];*/?><br>
                      <small>  <?php /*echo $data_user['study_center'];*/?></small>
                    </td>-->
