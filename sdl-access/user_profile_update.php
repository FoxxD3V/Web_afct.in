            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary"> <strong> Assigned State  </strong></h6>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group  ">
                        <div id="city_upd_by_sdl">
                          <label>Assigned State Director</label>
                          <select name=a_city_id" id="a_city_id" class="form-control  text-uppercase" required>
                            ...
                            <?php  
                            {
                              $qur=mysqli_query($DB_LINK,"select * from state where state_id='".$edit_data['a_state_id']."' and status=1   order by state") or die(mysqli_error());
                              foreach($qur as $city)
                              {
                                ?><option value="<?php echo $city['state_id'];?>" <?php   if($edit_data['a_state_id']==$city['state_id']) { echo 'selected';   } ?>><?php echo $city['state'];?></option>
                                <?php
                              }
                            }
                            ?>
