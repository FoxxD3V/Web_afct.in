...
<head>
  ...
  <title>Verified Student | <?php echo $SITE_NAME;?></title>
      ...
      <div id="content">
							...
							<div class="container-fluid">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-1">
                                    <h1 class="h3 mb-2 text-gray-800">Verified Student</h1>
								...
								<p class="mb-4">Verified Student list with basic info </p>


                                <!-- DataTales Example -->
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h6 class="m-0 font-weight-bold text-primary">Verified Student</h6>
              ...
              <!--<th>ACTION</th>-->
												...
												<?php
                                                $jcount=0;
                                                $qry_user= mysqli_query($DB_LINK,"SELECT * FROM  tbl_team_student where ref_id='" . $_SESSION[ 'a_userid' ] . "' and status =1 order by id desc ");
                ...
                <?php  }  ?>
                                                 ...
                                                 <!--           <td>
                                                                 <a  href="student_list_verified_add.php?edit=<?php /* echo $data_user['id']; */?>" ><i  style="color:blue " class="fa fa-edit fa-lg"></i></a>

                                                               <?php /* if($data_user['status']=='1'){ */?>
                                                                &nbsp;<a href="student_list_verified.php?ban=<?php /* echo $data_user['id']; */?> "  ><i class="fa fa-check fa-lg" style="color:green" title="Ban"></i>  </a>
                                                                <?php /* } else  { */?>
                                                                &nbsp;<a href="student_list_verified.php?unban=<?php /*echo $data_user['id']; */?> "  ><i class="fa fa-ban fa-lg" style="color:red" title="Unban"></i>  </a>
                                                                <?php /* }   */?>
                                                               <a href="javascript:void(0)"  onClick="return del(<?php /*echo $data_user['id']; */?>,'student_list_verified.php')"> <i class=" fa-lg fa fa-trash  "  style="color:red" title="Delete"></i>   </a>
