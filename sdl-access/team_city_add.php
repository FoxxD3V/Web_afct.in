...
require_once("../con_base/functions.inc.php");
        if(isset($_POST['save'])) {
          ...
          if ($_POST['a_sdl_id'] != '') {
            ...
            $sqlst = mysqli_query($DB_LINK, "select *  from tbl_team_state where user='" . $_POST['a_sdl_id'] . "' and status='1'") or die(mysqli_error());
            ...
            `ipaddress` ='$ip' $i1 ";
              ...
              $_SESSION['msg'] = array('error', 'State Director id not found !!!');
            }
          }
        }
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control  text-uppercase" name="a_sdl_id" id="a_sdl_id"   required  onChange="onchangeajax_for_sdl(this.value);">
                                                    ...
                                                    <?php $sql=mysqli_query($DB_LINK,"select * from tbl_team_state where status=1 and user ='".$_SESSION[ 'a_userid' ]."'order by user asc") or die(mysqli_error());
