...
if(isset($_GET['id']))
{
  $sql_reg="select * from  tbl_master_course_content where id= '".trim(dec($_GET['id']))."'";
...
<head>
  ...
  <title>Continue / Live Class | <?php echo $SITE_NAME; ?></title>
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-1">
         <!-- <h1 class="h3 mb-2 text-gray-800">Continue / Live Class</h1>-->


        </div>
        <!-- Page Heading -->

       <!-- <p class="mb-4">Continue / Live Class Viewer </p>
-->
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Course Video  </h6>
      ...
      <!-- /.container-fluid -->
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Course Summary  </h6>
